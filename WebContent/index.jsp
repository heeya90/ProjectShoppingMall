...
<body>
	...
	<li><a href="m_goods_list.tiles">상품</a></li>
	<li><a href="no_user_login.tiles">로그인</a></li>
	<li><a href="m_order_cart.tiles">장바구니</a></li>
	<li><a href="m_mypage_view.tiles">마이페이지</a></li>
	</ul>
</body>
</html>
