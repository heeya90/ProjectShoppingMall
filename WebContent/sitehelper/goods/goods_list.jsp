...
<script type="text/javascript" src="goods/js/goods_list.js"></script>
    ...
    <div id="content">
        <div class="admin_loca">HOME - 상품관리 - <B>상품리스트</B>
        </div>
        ...
        <div id="productListForm">
            ...
            <div class="admin_tsearch">
                ...
                <input type="button" name="searchButton" id="searchButton" value="검 색"
                class="clickbutton02" />
            </div>
            <div class="admin_arr_cen">
                <span class="admin_arr01">
                    ...
                    <label>
                        <input type="radio" name="productSort" value="categoryC_asc" />카테고리↑</label>
                    <!--label><input type="radio" name="productSort" value="price1_asc" />가격순↑</label-->
                    ...
                    <label>
                        ...
                        />등록순↓</label>
                    <label>
                        <input type="radio" name="productSort" value="categoryC_desc" />카테고리↓</label>
                    <label>
                        <input type="radio" name="productSort" value="price1_desc" />가격순↓</label>
                    <label>
                        <input type="radio" name="productSort" value="readCnt_desc" />조회순↓</label>
                </span>
            </div>
