                ...
                <table class="boardinput" summary="상품 등록" style="width: 780px;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="left" colspan="3">
                                <label>
                                    <input type="radio" name="prd_use" value="Y" checked="checked" />승인</label>
                                <label>
                                    <input type="radio" name="prd_use" value="N" />미승인</label>
                                <label>
                                    <input type="radio" name="prd_use" value="P" />일시품절</label>
                            </td>
                        </tr>
                        <!-- <tr>
