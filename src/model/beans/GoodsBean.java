...
public class GoodsBean {
	...
	private ArrayList<GoodsImgBean> img;
	...
	public String toString() {
		return "GoodsBean [no=" + no + ", code=" + code + ", category1="
				...
				+ ", redate=" + redate + ", inputdate=" + inputdate + ", size="
				+ size + ", color=" + color + ", img=" + img + ", use=" + use
				+ "]";
	}
	...
	public GoodsBean(int no, String code, int category1, int category2,
			...
			SizeBean size, ArrayList<GoodsColorBean> color, ArrayList<GoodsImgBean> img,
			String use) {
		super();
		this.no = no;
		this.code = code;
	...
	public void setColor(ArrayList<GoodsColorBean> color) {
		this.color = color;
	}

	public void setImg(ArrayList<GoodsImgBean> img) {
		this.img = img;
	}
	...
	public ArrayList<GoodsImgBean> getImg() {
		return img;
	}
